...
_tr_add2 after_install_etl     "更新到最新的 EndeavourOS$_question"
_tr_add2 after_install_etltip  "显示如何操作以更新到最新的 EndeavourOS"

_tr_add2 after_install_cdm     "更换显示管理器（DM）"
_tr_add2 after_install_cdmtip  "更换一个不同的显示管理器（Display Manager）"

_tr_add2 after_install_ew      "EndeavourOS 壁纸"
...
_tr_add2 general_info_text     "在 EndeavourOS 网站查看更多信息$_exclamation"
...
_tr_add2 general_info_dotip    "帮助 EndeavourOS 持续运转"
...
_tr_add2 cal_info2              "<b>离线</b>模式为您提供预设为 EndeavourOS 主题的 Xfce 桌面。\n不需要互联网连接。\n\n"
...
_tr_add2 ins_text              "安装 EndeavourOS 到磁盘"
_tr_add2 ins_start             "启动安装向导"
_tr_add2 ins_starttip          "启动 EndeavourOS 安装向导，并启动一个调试用的终端"
...
_tr_add2 after_install_themedef     "Xfce EndeavourOS 默认主题"
_tr_add2 after_install_themedeftip  "使用 Xfce 的 EndeavourOS 默认主题"
