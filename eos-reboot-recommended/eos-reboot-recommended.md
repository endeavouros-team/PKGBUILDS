...
`eos-reboot-recommended` is a package that shows a notification about a reboot recommendation after the update of certain core system packages, e.g. the running kernel.
