...
eos-pkginfo | Show usage and/or developer information about an EndeavourOS/Arch/AUR package.<br>Usage: `eos-pkginfo <package-name>`
...
<pre>
# Make pkgi as an alias to eos-pkginfo:
